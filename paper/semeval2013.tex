...
edge in the graph) there is a pairwise potential function (phi i j) that
assigns a penalty to any assignment of the \emph{pair} of variables.
...
These joint probabilities are estimated from the training data; we simply take
the MLE 
