...
\section{MRF}
\begin{figure}
  \includegraphics[width=8cm]{pentagram.pdf}
  \label{pentagram}
...
(XXX cite europarl) is a parallel corpus of proceedings of the European
Parliament, which is available in XXX languages, although not every sentence is
