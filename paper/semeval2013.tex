...
%% TODO(alexr): " So before that paragraph, I'd insert a
%% short paragraph saying what they were (and explaining what "MRF" stands for)
...
the Europarl Intersection corpus; that is, the English-language source
...
(XXX add reference for loopy bp)
